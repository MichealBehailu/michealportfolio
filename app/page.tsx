        ...
        <div className="p-10 m-4 flex justify-center items-center">
          <p className="text-3xl font-semibold inline-block  ">
            ...
            <span className="underline inline-flex items-center">
              {" "}
              <Link href="https://github.com/MichealBehailu?tab=repositories" target="_blank">projects</Link> <MoveUpRight />
            </span>{" "}
          </p>
        </div>
      </section>
        ...
        <div className="flex flex-row ">
          <div className="p-10 m-4 flex flex-col items-center">
            ...
            <div className="mt-4 flex flex-col items-center gap-3 ">
              ...
              <svg
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#FFA500] transition-all duration-300"
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <svg
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#0000FF] transition-all duration-300"
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <svg
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#008080] transition-all duration-300"
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <div className="p-10 m-4 flex flex-col items-center">
            <p className="text-2xl ">Backend Technologies</p>
            <div className="mt-4 flex flex-col gap-3">
              <svg
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#008000] transition-all duration-300"
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <svg
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#57B2F7] transition-all duration-300"
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <svg
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#aab7c1ff] transition-all duration-300"
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <svg
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#57f764ff] transition-all duration-300 "
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <svg
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#2d2d2dff] transition-all duration-300 "
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <div className="p-10 m-4 flex flex-col items-center">
            <p className="text-2xl ">Database Technologies</p>
            <div className="mt-4 flex flex-col gap-3">
              <svg
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#336791] transition-all duration-300"
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <svg
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#003B57] transition-all duration-300 "
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <svg
                className="w-20 h-20  hover:scale-105 hover:drop-shadow-[0_0_20px_#47ef0fff] transition-all duration-300"
                role="img"
                viewBox="0 0 24 24 "
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <svg
                className="w-20 h-18 hover:scale-105 hover:drop-shadow-[0_0_20px_#57f7caff] transition-all duration-300"
                role="img"
                viewBox="0 0 24 24  "
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          {/* Other Languages */}
          <div className="p-10 m-4 flex flex-col ">
            <p className="text-2xl ">Programming Languages</p>
            <div className="mt-4 flex flex-col items-center gap-3">
              <svg
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#306998] transition-all duration-300 "
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <svg
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#C74747] transition-all duration-300"
                role="img"
                viewBox="0 0 24 24 "
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <Image
                src={csharp}
                alt="Csharp"
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#A37EF2] transition-all duration-300"
                width={50}
                height={50}
              />
              <Image
                src={java}
                alt="java"
                className="w-20 h-20 hover:scale-105 hover:drop-shadow-[0_0_20px_#6A1B9A] transition-all duration-300"
                width={50}
                height={50}
              />
              <Image
                src={asm}
                alt="java"
                className="w-20 h-20  hover:scale-105 hover:drop-shadow-[0_0_20px_#007BFF] transition-all duration-300 grayscale"
                width={50}
                height={50}
              />
            </div>
